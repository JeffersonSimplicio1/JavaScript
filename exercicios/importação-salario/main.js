...
function calcularPercentagem(valor, percentagem) {
  return valor * (percentagem / 100);
}
function percentualBaseadoNoSalario(salario) {
...
const valorATransferir = valorSalarioBruto + beneficios - calcularPercentagem(valorSalarioBruto, percentualBaseadoNoSalario(valorSalarioBruto));
